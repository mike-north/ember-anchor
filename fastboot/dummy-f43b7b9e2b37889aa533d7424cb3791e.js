...
define('dummy/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"dummy","environment":"production","baseURL":"ember-anchor/","locationType":"hash","EmberENV":{"FEATURES":{},"RAISE_ON_DEPRECATION":true},"contentSecurityPolicy":{"style-src":"'self' 'unsafe-inline'","img-src":"'self' https://camo.githubusercontent.com","default-src":"'none'","script-src":"'self'","font-src":"'self'","connect-src":"'self'","media-src":"'self'"},"emberAnchor":{"anchorQueryParam":"anc"},"APP":{"name":"ember-anchor","version":"0.1.2+3fd88852","autoboot":false},"contentSecurityPolicyHeader":"Content-Security-Policy-Report-Only","exportApplicationGlobal":false}};
});
